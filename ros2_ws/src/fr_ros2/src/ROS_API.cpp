           ...
           rclcpp::NodeOptions().use_intra_process_comms(true))
{
    ...
    _skip_answer_flag = 0;
    this->declare_parameter<uint8_t>("toolcoord_install",2);//默认工具安装在机器人末端
    this->declare_parameter<uint8_t>("toolcoord_type",2);//默认是工具坐标系
    ...
    this->declare_parameter<int>("MoveJLC_tool",2);
    ...
    this->declare_parameter<int>("Spline_tool",2);
