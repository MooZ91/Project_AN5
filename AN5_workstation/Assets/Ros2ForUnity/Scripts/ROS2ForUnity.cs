...
internal class ROS2ForUnity
{
    ...
    private string GetOSName()
    {
        switch (GetOS())
        {
            ...
            default: throw new System.NotSupportedException($"Unsupported platform: {Application.platform}");
        }
    }
    ...
    private string GetEnvPathVariableName()
    {
        switch (GetOS())
        {
            case Platform.Windows: return "PATH";
            case Platform.macOS:   return "DYLD_LIBRARY_PATH";
