...
public class recordPanel : MonoBehaviour
{
    ...
    private void OnSpeedSliderChanged(float value)
    {
        ...
        speedSlider.SetValueWithoutNotify(speed); // Igual que en ControlArticular.OnSliderValueChanged:
        // reasignar con "value =" dentro del propio callback de onValueChanged puede
        // volver a disparar el evento y, en el peor caso, no converger (esto llegó a
        // tirar abajo el Editor con un desborde de pila en un slider similar).
        if (speedInputField != null)
        {
